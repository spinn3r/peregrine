...
TEST_COMMAND="pkill -9 -u nobody java 2> /dev/null ; export HOSTNAME=localhost && export ANT_OPTS=-Xmx512M && ant clean jar compile.test jar && time ant -Dperegrine.test.backend=processes test"
