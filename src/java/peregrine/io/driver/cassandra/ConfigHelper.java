...
public class ConfigHelper
{
     ...
     * @param columnFamily
     */
    public static void setInputColumnFamily(StructMap conf, String keyspace, String columnFamily)
    {
        if (keyspace == null)
        {
     ...
     * @param columnFamily
     */
    public static void setOutputColumnFamily(StructMap conf, String keyspace, String columnFamily)
    {
        if (keyspace == null)
        {
            throw new UnsupportedOperationException("keyspace may not be null");
     ...
     */
    public static void setRangeBatchSize(StructMap conf, int batchsize)
    {
     ...
     */
    public static int getRangeBatchSize(StructMap conf)
    {
     ...
     */
    public static void setInputSplitSize(StructMap conf, int splitsize)
    {
        conf.setInt(INPUT_SPLIT_SIZE_CONFIG, splitsize);
    }

    public static int getInputSplitSize(StructMap conf)
    {
     ...
     * @param predicate
     */
    public static void setInputSlicePredicate(StructMap conf, SlicePredicate predicate)
    {
        conf.set(INPUT_PREDICATE_CONFIG, predicateToString(predicate));
    }

    public static SlicePredicate getInputSlicePredicate(StructMap conf)
    {
        return predicateFromString(conf.get(INPUT_PREDICATE_CONFIG));
    }

    public static String getRawInputSlicePredicate(StructMap conf)
    {
     ...
     * @param conf Job configuration you are about to run
     */
    public static void setInputRange(StructMap conf, String startToken, String endToken)
    {
    ...
    public static KeyRange getInputKeyRange(StructMap conf)
    {
    ...
    public static String getInputKeyspace(StructMap conf)
    {
        return conf.get(INPUT_KEYSPACE_CONFIG);
    }
    
    public static String getOutputKeyspace(StructMap conf)
    {
        return conf.get(OUTPUT_KEYSPACE_CONFIG);
    }
    
    public static String getInputKeyspaceUserName(StructMap conf)
    {
    	return conf.get(INPUT_KEYSPACE_USERNAME_CONFIG);
    }
    
    public static String getInputKeyspacePassword(StructMap conf)
    {
    	return conf.get(INPUT_KEYSPACE_PASSWD_CONFIG);
    }

    public static String getOutputKeyspaceUserName(StructMap conf)
    {
    	return conf.get(OUTPUT_KEYSPACE_USERNAME_CONFIG);
    }
    
    public static String getOutputKeyspacePassword(StructMap conf)
    {
    	return conf.get(OUTPUT_KEYSPACE_PASSWD_CONFIG);
    }

    public static String getInputColumnFamily(StructMap conf)
    {
        return conf.get(INPUT_COLUMNFAMILY_CONFIG);
    }
    
    public static String getOutputColumnFamily(StructMap conf)
    {
        return conf.get(OUTPUT_COLUMNFAMILY_CONFIG);
    }

    public static String getReadConsistencyLevel(StructMap conf)
    {
        return conf.get(READ_CONSISTENCY_LEVEL, "ONE");
    }

    public static String getWriteConsistencyLevel(StructMap conf)
    {
        return conf.get(WRITE_CONSISTENCY_LEVEL, "ONE");
    }

    public static int getRpcPort(StructMap conf)
    {
        return Integer.parseInt(conf.get(THRIFT_PORT));
    }

    public static void setRpcPort(StructMap conf, String port)
    {
        conf.set(THRIFT_PORT, port);
    }

    public static String getInitialAddress(StructMap conf)
    {
        return conf.get(INITIAL_THRIFT_ADDRESS);
    }

    public static void setInitialAddress(StructMap conf, String address)
    {
        conf.set(INITIAL_THRIFT_ADDRESS, address);
    }

    public static void setPartitioner(StructMap conf, String classname)
    {
        conf.set(PARTITIONER_CONFIG, classname); 
    }

    public static IPartitioner getPartitioner(StructMap conf)
    {
        try
        {
    ...
    public static Cassandra.Client getClientFromAddressList(StructMap conf) throws IOException
    {
